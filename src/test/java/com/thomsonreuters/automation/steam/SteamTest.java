...
/**
 * The SteamTest program is an entry point for running Steam API test cases. This class initializes app name, excel file
 * path and xml templates folder path which are utilized by SteamAbstractBase.
 *
 * @author Janardhan
 * @version 1.0
 * @since 2016-03-31
